...
public class ArrayBinaries {

    public static final char DEFAULT_DELIMITER = '/';
    public static final int SIZE = 4;
    public static String getBinaryCodeForDigit(char d){
        switch (d){
    ...
    public static String getCodedInteger(int x){
    ...
    public static char getDecodedChar(String bin){
